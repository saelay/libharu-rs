...
fn main() -> anyhow::Result<()> {
    ...
    for font in &detail_font {
        ...
        for _ in 0..jptext.len()/2 {
            page.move_to(x_pos, y - 10.0);
            page.line_to(x_pos, y - 12.0);
            page.stroke();
            x_pos = x_pos + 30.0;
        }

        const PAGE_HEIGHT:libharu::Real = 210.0;
        page.set_width(x + 20.0);
        page.set_height(PAGE_HEIGHT);

        page.move_to(10.0, PAGE_HEIGHT - 25.0);
        page.line_to(x + 10.0, PAGE_HEIGHT - 25.0);
        page.stroke();

        page.move_to(10.0, PAGE_HEIGHT - 85.0);
        page.line_to(x + 10.0, PAGE_HEIGHT - 85.0);
        page.stroke();

        page.move_to(10.0, y - 12.0);
        page.line_to(x + 10.0, y - 12.0);
        page.stroke();
    }
